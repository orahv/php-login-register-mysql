...
if($row) {
    ...
    echo '<script>alert("welcome ', $res['u_fullname'],'");window.location="index.php";</script>';
} else {
    echo '<script>alert("username or password not correct!");window.location="login.php";</script>';
}