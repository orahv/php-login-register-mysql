    ...
    <div class="container">
        <div class="register-box bg-light p-5 rounded mt-3">
            ...
            <form method="post" action="register_action.php">
                <div class="mb-3">
                    <label for="u_fullname" class="form-label">Name</label>
                    <input type="text" class="form-control" id="u_fullname" name="u_fullname" placeholder="Name" required>
                </div>
                <div class="mb-3">
...
System administrator</option>
                ...
                <a href="login.php" class="w-100 btn btn-lg btn-danger mt-3">Cancel</a>
            </form>
        </div>
    </div>
</body>
